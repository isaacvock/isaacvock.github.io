...
Every now and then, you'll see a paper/review claim that cellular growth
rates need to be accounted for when modeling the kinetics of RNA
synthesis, and especially, degradation. For example, a [recent preprint](https://www.biorxiv.org/content/10.64898/2025.12.18.695252v1)
...
labeling data. Is this true? In short, the answer is mostly no, growth rates have only
a minor influence on NR-seq kinetic parameter estimates. In more detail:
