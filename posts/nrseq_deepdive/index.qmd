...
labeling data. Is this true? In short, the answer is no, growth rates do
not directly influence NR-seq kinetic parameter estimates. In more detail:
...
-   Cell's respond to growth by regulating their RNA synthesis and
    ...
    ever at steady-state.
-   Thus, growth can indirectly bias kinetic parameter estimates if the
