...
![**Figure 2:** (From (Vock et al. 2025)) Simple mutation cutoff
...
![**Figure 3:** (Adapted from (Vock et al. 2023)) Two-component binomial
...
like rmapalign3N (Muller et al. 2025). As STAR is more widely used and actively maintained
...
VarScan [@RN461] or BCFtools (Danecek et al. 2021). Also, while SNP calling has been shown to
...
method variations, etc. than those from pulse-chases (Vock et al. 2025).
...
mapped onto (Lotfollahi et al. 2022; Lotfollahi et al. 2024).
