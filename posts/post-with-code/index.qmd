...
TC <- rbinom(reads, size = nT, prob = pnew*newness + (1-newness)*pold)
...
T's) from a binomial distribution:
...
new probability of sampling a labeled RNA. Simulating all of this looks
like:
