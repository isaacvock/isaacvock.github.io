...
With the first official CRAN release of [EZbakR](https://cran.r-project.org/web/packages/EZbakR/index.html) (version 0.1.0) and the (unrelated) release of fastq2EZbakR [version 0.8.0](https://github.com/isaacvock/fastq2EZbakR/releases/tag/v0.8.0), I decided to write this brief blog to discuss the present and future of the EZbakR suite.
